...
SCHEDULE = {
  "even": {
    "monday": [
      ...
      {
        "time": "15:10-16:40",
        "subject": "МЕТОДЫ МАТЕМАТИЧЕСКОГО МОДЕЛИРОВАНИЯ СЛОЖНЫХ ПРОЦЕССОВ И СИСТЕМ",
        "type": "лекция",
      ...
      {
        "time": "16:50-18:20",
        "subject": "ТЕХНОЛОГИИ РАЗРАБОТКИ WEB-ПРИЛОЖЕНИЙ",
        "type": "лабораторная",
        "teacher": "Демидюк В. Д.",
    ...
    "wednesday": [
      ...
      {
        "time": "11:30-13:00",
        "subject": "ОБЪЕКТНО-ОРИЕНТИРОВАННОЕ ПРОЕКТИРОВАНИЕ",
        "type": "лекция",
        "teacher": "Якимов С. П.",
